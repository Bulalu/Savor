            ...
            <Row>
              <Col md={24} sm={24} xs={24}>
                <div className="footer-center">
                  <a href={"https://discord.gg/7VWH7Rxk"} alt={"Join Savor Discord"}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="150px" viewBox="0 0 292 80" fill="none">
                  ...
                  <p style={{ paddingTop: "5px", color:"white" }}>Savor - You just earn. 2022</p>
                </div>
              </Col>
            </Row>
          </div>
